...
('gasto','previsto','Estrutura','Aluguel da casa de praia',4700,1),
('gasto','previsto','Estrutura','Som e iluminação (DJ booth + caixas)',1500,1),
('gasto','previsto','Estrutura','Gerador / energia reserva (casa isolada)',600,1),
('gasto','previsto','Equipe','DJs (line-up)',600,3),
('gasto','previsto','Equipe','Barmen',350,2),
('gasto','previsto','Equipe','Seguranças (casa isolada)',450,3),
